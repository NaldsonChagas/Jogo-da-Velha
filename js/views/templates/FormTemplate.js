  ...
  getTemplate() {
    ...
    <form>
      <div class="form-group">
        ...
        <input type="text" name="player1-name" id="player1-name" placeholder="Seu nome" class="form-control" required>
      ...
      <div class="form-group">
        <label for="name">Nome:</label>
        <input type="text" name="player2-name" id="player2-name" placeholder="Seu nome" class="form-control" required>
      </div>
